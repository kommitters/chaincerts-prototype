...
export const AMOUNT = '0.0000001';
export const STARTING_BALANCE = '3';
...
export const SUCCESS_MESSAGE =
  "\n✅ Congratulations on successfully generating your certificate! To access it, please visit the Chaincerts visualizer at https://demo.chaincerts.co/ and enter the recipient's Stellar account: ";
