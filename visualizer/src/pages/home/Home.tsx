...
const PUBLIC_KEY_FIRST = 'GBAUDP62XLJAE65MHGHPHKGTVN7GICVCFSPYCONVLB7Y357T5NKKYN3P';
const PUBLIC_KEY_SECOND = 'GB2HN7F6422JSYTQJ7VMABYSG22QPBEVA25XIKAPGREKK2PSMF4D5F7V';
const SIZE_CHAR = 6;
