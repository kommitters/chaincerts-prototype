...
const Navbar = () => {
  ...
  return (
    <div className="navbar text-white h-24 flex flex-row lg:w-5/6 w-full mx-auto">
      ...
      <div className="flex-none flex-wrap">
        <button
          className="btn btn-ghost btn-secondary btn-sm rounded-full px-3 border border-solid border-white"
          onClick={() => navigate('/')}
        >
          <svg
